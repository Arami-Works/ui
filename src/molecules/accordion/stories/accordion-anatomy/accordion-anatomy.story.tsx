    ...
    <XStack backgroundColor="#FFFFFF" borderRadius={12} borderWidth={1} borderColor="#E0E0E0" padding={24} gap={48} alignItems="center">
      <YStack width={360} gap={0}>
        <View position="relative">
          <XStack height={56} alignItems="center" paddingHorizontal={16} gap={16} backgroundColor="#FFFBFE">
            <View width={24} height={24} borderRadius={4} backgroundColor="#E8DEF8" />
            <YStack flex={1}>
              <Text fontSize={16} color="#1C1B1F">Title</Text>
              <Text fontSize={14} color="#49454F">Supporting text</Text>
            </YStack>
            <Text fontSize={20} color="#49454F">&#x25BC;</Text>
          </XStack>
          <View paddingHorizontal={16} paddingVertical={16} backgroundColor="#FFFBFE">
            <Text fontSize={14} color="#1C1B1F">Collapsible content area</Text>
          </View>
          ...
          <View position="absolute" top={8} left={56}><Callout number={3} /></View>
          <View position="absolute" top={24} left={56}><Callout number={4} /></View>
          <View position="absolute" top={8} right={-12}><Callout number={5} /></View>
          <View position="absolute" top={64} left={-12}><Callout number={6} /></View>
          <View position="absolute" bottom={-12} left={-12}><Callout number={7} /></View>
        </View>
      </YStack>
      <YStack gap={12}>
