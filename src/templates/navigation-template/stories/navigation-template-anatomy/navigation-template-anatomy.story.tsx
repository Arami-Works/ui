    ...
    >
      ...
      >
        <View position="relative" width={200} height={280}>
          ...
          <View position="absolute" top={100} right={-30}>
            <Callout number={1} />
          </View>
      ...
      <YStack gap={12}>
        <LegendItem number={1} label="Content slot (children) — fills space" />
        <LegendItem number={2} label="Nav bar slot — pinned to bottom" />
      </YStack>
    </XStack>
  );
}
...
const meta: Meta = {
  title: "templates/navigation-template/anatomy",
  component: Anatomy,
  tags: ["autodocs", "!dev"],
  parameters: {
    design: {
